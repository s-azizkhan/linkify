    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="flex items-center justify-between px-8 py-5 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/s-azizkhan/linkify"
            target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <div
                key={feature.title}
                className={`p-5 rounded-xl bg-card border transition-all duration-300 group ${activeFeature === i ? 'border-primary/50 shadow-lg shadow-primary/10' : 'border-border hover:border-primary/20'
                  }`}
              >
      ...
      <footer className="px-8 py-10 text-center text-sm text-muted-foreground border-t border-border">
        <p className="mb-2">
          Crafted with <span className="text-red-500">♥</span> by <a href="https://justaziz.com" target="_blank" rel="noopener noreferrer" className="font-bold text-foreground hover:underline">S.Aziz Khan</a>
        </p>
